...
Source: 15-Challenge竞赛/LeHome/README.md
Source SHA-256: 55285f59d77b6aebceedb08315dd66685bd35d003b0a36a609d1889d9d04db15
...
- `LeHome` Repository path: `/root/lehome-challenge`
...
- `output_dir`
  - Changed to the data disk, such as `/root/gpufree-data/lehome-outputs/train/act_top_short`.
