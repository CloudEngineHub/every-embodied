...
Source: 10-具身智能其他仿真工具及仿真前沿/Genesis仿真环境配置/02可视化和渲染.md
Source SHA-256: 65e165e41c21b19d695001f43cf4bdeacbcba976d2e5cd33ce493c8f400da4af
...
2. The translation must retain all separators in the form [[EE_KEEP_0000]], keeping their quantity, order, and position unchanged. These symbols must not be omitted, escaped, or translated.
3. Model names, repository names, command names, parameter names, and English abbreviations should remain unchanged.
