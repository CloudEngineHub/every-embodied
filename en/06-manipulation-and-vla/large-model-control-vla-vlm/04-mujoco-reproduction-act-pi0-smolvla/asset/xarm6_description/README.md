...
<p float="left">
  <img src="../../../../../../06-策略抓取或抓取VLA/大模型控制、VLA、VLM/04mujoco复现ACT、Pi0、SmolVLA/asset/xarm6_description/lite6.png" width="400">
  <figcaption>No gripper</figcaption>
</p>

<p float="left">
  <img src="../../../../../../06-策略抓取或抓取VLA/大模型控制、VLA、VLM/04mujoco复现ACT、Pi0、SmolVLA/asset/xarm6_description/lite6_gripper_wide_closed.png" width="200">
  <img src="../../../../../../06-策略抓取或抓取VLA/大模型控制、VLA、VLM/04mujoco复现ACT、Pi0、SmolVLA/asset/xarm6_description/lite6_gripper_wide_open.png" width="200">
  <figcaption>Wide gripper configuration, fully closed (initial position) and open</figcaption>
</p>

<p float="left">
  <img src="../../../../../../06-策略抓取或抓取VLA/大模型控制、VLA、VLM/04mujoco复现ACT、Pi0、SmolVLA/asset/xarm6_description/lite6_gripper_narrow_closed.png" width="200">
  <img src="../../../../../../06-策略抓取或抓取VLA/大模型控制、VLA、VLM/04mujoco复现ACT、Pi0、SmolVLA/asset/xarm6_description/lite6_gripper_narrow_open.png" width="200">
  <figcaption>Narrow gripper configuration, fully closed (initial position) and open</figcaption>
</p>
...
This model is released under a [BSD-3-Clause License](../../../../../../06-策略抓取或抓取VLA/大模型控制、VLA、VLM/04mujoco复现ACT、Pi0、SmolVLA/asset/xarm6_description/LICENSE).
