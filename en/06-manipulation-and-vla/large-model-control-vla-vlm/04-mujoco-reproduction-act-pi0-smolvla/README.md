...
## 2. Replay Data
Run [2.visualize_data-omy.ipynb](../../../../06-策略抓取或抓取VLA/大模型控制、VLA、VLM/04mujoco复现ACT、Pi0、SmolVLA/2.visualize_data-omy.ipynb).
...
- [pi0_omy.yaml](../../../../06-策略抓取或抓取VLA/大模型控制、VLA、VLM/04mujoco复现ACT、Pi0、SmolVLA/pi0_omy.yaml): Training configuration
...
- [train_model.py](../../../../06-策略抓取或抓取VLA/大模型控制、VLA、VLM/04mujoco复现ACT、Pi0、SmolVLA/train_model.py): Training script
- [smolvla_omy.yaml](../../../../06-策略抓取或抓取VLA/大模型控制、VLA、VLM/04mujoco复现ACT、Pi0、SmolVLA/smolvla_omy.yaml): Training configuration
