# Training and Evaluating SmolVLA on LIBERO
...
## Training SmolVLA on the Public Subset
...
<img width="740" height="635" alt="SmolVLA LIBERO training log" src="../../../../06-策略抓取或抓取VLA/大模型控制、VLA、VLM/01SmolVLA-LIBERO/assets/image-20251030144540186.png" />
...
File "$LIBERO_ROOT/libero/libero/benchmark/\_\_init\_\_.py", line 164, in get\_task\_init\_states
init\_states = torch.load(init\_states\_path)
File "$LEROBOT_ENV/lib/python3.10/site-packages/torch/serialization.py", line 1524, in load
