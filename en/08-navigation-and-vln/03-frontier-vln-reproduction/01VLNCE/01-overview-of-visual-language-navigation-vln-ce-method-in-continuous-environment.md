...
Source: 08-具身导航及VLN/03前沿VLN复现/01VLNCE/01连续环境下视觉语言导航（VLN-CE）方法概述.md
Source SHA-256: 8bc7035a6c3e9f18c449fe3a5b2c03c861d51b4047c8005d5f30291a8929b0d6
...
### Discrete Environment Visual Language Navigation (VLN) Task Setup
...
### Navigation Language in Continuous Environment (VLNCE) Task Setup
...
# Continuous Environmental Visual Language Navigation Method

## 1. Traditional single-stage method

### Basic End-to-End Baseline Model (2020 ECCV)
...
## 2. Traditional Two-Stage Navigation Method
...
### (1) Introduction of the waypoint predictor: The beginning of two-stage navigation
...
### (3) Method Based on Future Imagination
...
### (4) Methods based on Sim2Real (Virtual-to-Real Migration)
...
## 3. Zero-Shot Visual Language Navigation (Zero-Shot VLN)
...
## 4. Methods Based on VLA (Vision-Language-Action)
