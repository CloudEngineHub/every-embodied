...
It is suitable to be placed in the `17-具身世界模型` section of this repository, following RAW-Dream, WoG, WALL-WM, RoboDream, and Gamma-World. The reason is clear: BWM clearly defines itself as a **physically consistent, action-conditioned video world model**, aiming to provide a low-cost, high-fidelity video-level world simulator for robot manipulation.
