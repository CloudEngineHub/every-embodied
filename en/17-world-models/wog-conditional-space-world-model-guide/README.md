...
Source: 17-具身世界模型/WoG条件空间世界模型导读/README.md
Source SHA-256: 080a301add82763f497c08433b3f6984547a6cbb0049143b2705fd02c35a25ea
Model: tencent/Hy-MT2-1.8B-GGUF:Q4_K_M
Review machine-translated technical claims before relying on them.
-->
# WoG: Introduction to the World Model of Conditional Space

This introduction corresponds to the paper **World Guidance: World Modeling in Condition Space for Action Generation**. The method name is **WoG / World Guidance**, developed by the ByteDance Seed and Hong Kong University teams. It was submitted to arXiv on 2026-02-25. It is suitable to be placed in the `17-具身世界模型` section of this repository as a supplement to LeWM and RAW-Dream: LeWM explains how a latent world model predicts future states, RAW-Dream explains how a world model serves as a VLA training environment, and WoG takes a different approach: **it does not predict the complete future image, but predicts a future condition vector useful for actions**.
...
This article does not recommend reproduction from scratch right away. It is more appropriate for everyone to first thoroughly understand the architecture diagram and two-stage training, before deciding whether to invest computing power in running SIMPLER or deploying on a real robot.
