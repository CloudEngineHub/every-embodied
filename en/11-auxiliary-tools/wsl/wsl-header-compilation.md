# Wsl Header Compilation

wsl requires compiling the header.
...
Stored in the folder WSL2-Linux-Kernel-linux-msft-wsl-6.6.87.2/modules.vhdx

The generated kernel is located at Kernel: WSL2-Linux-Kernel-linux-msft-[wsl](https://so.csdn.net/so/search?q=wsl&spm=1001.2101.3001.7020)-6.6.87.2/arch/x86/boot/bzImage
