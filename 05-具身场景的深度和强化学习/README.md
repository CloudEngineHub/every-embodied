...
如果大家刚接触机器人强化学习，建议先看 HIMLoco 章节，理解 proprioception、privileged critic 和 sim-to-real 的基本思路；然后通过 Open Duck Mini/Microduck 做一次体量更小、资产和命令更清晰的双足训练练习；再看 AGILE 章节，学习更完整的人形机器人任务配置、teacher-student 蒸馏、评估报告和 Sim2MuJoCo 复核流程。对 VLA、世界模型后训练或人类示教数据感兴趣的同学，可以继续看 Robots That Know What to Ask，重点理解 reward misalignment、欠指定特征和 human-in-the-loop 奖励修正。
