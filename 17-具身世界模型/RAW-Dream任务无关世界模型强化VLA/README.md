...
本章导读论文 **Reinforcing VLAs in Task-Agnostic World Models**，方法名为 **RAW-Dream**。截至 2026-06-27，作者主页和 arXiv 页面尚未给出官方代码仓库，因此本章聚焦“世界模型 + VLA 后训练”的方法原理、实验结论和复现准备。
...
官方代码公开后，可在本目录增加独立复现章节；本章作为论文导读和资料导航保留。
